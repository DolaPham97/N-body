...
*/
    ...
    public void xrebelion() {
        data[0] = data[0] * -0.8;
        
    }
    
    public void yrebelion() {
        data[1] =data[1] * -0.8;
    }
    ...
    /**
     * If both vectors doesn't equals to each other it throw it out.
     * Then the length of the vector is adding up longer and we will take the sum of each vector 
     * 
     * @param that describe the new Vector
     * @return 
     */
